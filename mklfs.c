...
int main(int argc, char *argv[])
{
	...
	// printf("block_size_in_sectors = %d\nint segment_size_in_blocks = %d\nint flash_or_log_size_in_segments = %d\nint wear_limit_for_earased_blocks = %d\n",block_size_in_sectors, segment_size_in_blocks,flash_or_log_size_in_segments,wear_limit_for_earased_blocks);

	// printf("Successfully created the flash file.\n");
	return 0;
}
